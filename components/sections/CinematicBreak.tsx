  ...
  return (
    <section className="overflow-hidden bg-dark-section text-white">
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-20 md:px-8 md:py-28 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
        ...
        <div className="relative min-w-0 border border-white/15 bg-paper p-3 shadow-[0_28px_80px_rgba(0,0,0,0.22)] sm:p-5">
          <div className="relative aspect-[5/4] overflow-hidden bg-paper">
            <Image src="/images/products/12.png" alt="Electric concrete mixer" fill quality={85} sizes="(max-width: 1024px) 100vw, 650px" className="object-contain mix-blend-multiply" />
          </div>
