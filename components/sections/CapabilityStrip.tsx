      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-3 px-5 py-6 sm:grid-cols-2 sm:gap-4 md:px-8 xl:grid-cols-4">
        {items.map(({ icon: Icon, title, detail }, index) => (
          <motion.div
            ...
            className={`capability-reveal ${styles.card} group relative flex min-h-24 items-center gap-4 overflow-hidden rounded-xl border border-line bg-surface/40 px-4 py-4 transition-colors hover:border-accent/35 hover:bg-surface/75`}
          >
